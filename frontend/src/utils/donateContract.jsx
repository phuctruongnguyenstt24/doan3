...
const DONATE_CONTRACT_ADDRESS = import.meta.env.VITE_CONTRACT_ADDRESS || '';
...
export const getDonateContractReadOnly = async () => {
  if (!isDonateContractConfigured()) return null;
...
export const sendDonation = async (amountEth, message) => {
  try {
    ...
    if (!contract) throw new Error('Chưa cấu hình VITE_CONTRACT_ADDRESS hoặc chưa có ví.');
