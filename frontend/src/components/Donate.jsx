...
const Donate = () => {
  ...
  const handleDonate = async () => {
    ...
    if (!configured) {
      setStatus({ type: 'error', text: 'Chưa cấu hình VITE_DONATE_CONTRACT_ADDRESS trong .env.' });
      return;
    }
      ...
      <div className="mx-auto max-w-5xl">
        ...
        {!configured && (
          <div className="mb-8 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-5 text-amber-200 text-sm">
            ...
            <code className="rounded bg-black/30 px-1.5 py-0.5">VITE_DONATE_CONTRACT_ADDRESS</code> vào file{' '}
